 ...
 *
 * If a function returns an error that operates on a connected mqttClient (e.g publish, keep_alive, etc.) the caller should
...
/**
 * Forward declaration of the mqttClient object.
 */
...
/**
 * Will initialize the specified mqttClient object.
 *
 * @param client - The mqttClient object.
...
/**
 * Will set the network reference and callbacks for this mqttClient object.
 *
 * @param client - The mqttClient object.
...
/**
 * Will set the timer references and callbacks for this mqttClient object.
 *
 * @param client - The mqttClient object.
...
/**
 * Will configure the mqttClient to drop packets that overflow the read buffer. If a counter is provided it will be
...
/**
 * Will send a subscribe packet with multiple mqttTopic filters plus QOS levels and wait for the suback to complete.
 *
 * Note: The message callback might be called with incoming messages as part of this call.
 *
 * @param client - The mqttClient object.
 * @param count - The number of mqttTopic filters and QOS levels.
 * @param topic_filter - The list of mqttTopic filters.
...
/**
 * Will send a subscribe packet with a single mqttTopic filter plus QOS level and wait for the suback to complete.
 *
 * Note: The message callback might be called with incoming messages as part of this call.
 *
 * @param client - The mqttClient object.
 * @param topic_filter - The mqttTopic filter.
...
/**
 * Will send an unsubscribe packet with multiple mqttTopic filters and wait for the unsuback to complete.
 *
 * Note: The message callback might be called with incoming messages as part of this call.
 *
 * @param client - The mqttClient object.
 * @param count - The number of mqttTopic filters.
 * @param topic_filter - The mqttTopic filter.
 * @param timeout - The command timeout.
 * @return An error value.
 */
...
/**
 * Will send an unsubscribe packet with a single mqttTopic filter and wait for the unsuback to complete.
 *
 * Note: The message callback might be called with incoming messages as part of this call.
 *
 * @param client - The mqttClient object.
...
/**
 * Will send a disconnect packet and finish the mqttClient.
 *
 * @param client - The mqttClient object.
 * @param timeout - The command timeout.
 * @return An error value.
...
/**
 * Will yield control to the mqttClient and receive incoming packets from the network.
 *
 ...
 * data is available and then yield to the mqttClient if data is available. All applications may specify the amount of bytes
...
/**
 * Will yield control to the mqttClient to keep the connection alive.
 *
