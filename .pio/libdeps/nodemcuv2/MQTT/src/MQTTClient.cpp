...
static void MQTTClientHandler(lwmqtt_client_t * /*mqttClient*/, void *ref, lwmqtt_string_t topic,
                              lwmqtt_message_t message) {
  // get callback
  auto cb = (MQTTClientCallback *)ref;

  // null terminate mqttTopic
...
void MQTTClient::setWill(const char topic[], const char payload[], bool retained, int qos) {
  // return if mqttTopic is missing
...
bool MQTTClient::connected() {
  // a mqttClient is connected if the network is connected, a mqttClient is available and
